...
reg [wl-1:0] rtl_tx_real [0:max_output_samples-1];
reg [wl-1:0] rtl_tx_imag [0:max_output_samples-1];
...
reg [wl-1:0] matlab_tx_real [0:max_output_samples-1];
reg [wl-1:0] matlab_tx_imag [0:max_output_samples-1];
...
if (test_case == 0) begin
    $readmemb("matlab_tx_real_H_0.txt", matlab_tx_real);
    $readmemb("matlab_tx_imag_H_0.txt", matlab_tx_imag);
end 
else if (test_case == 1) begin
    $readmemb("matlab_tx_real_H_1.txt", matlab_tx_real);
    $readmemb("matlab_tx_imag_H_1.txt", matlab_tx_imag);
end 
else if (test_case == 2) begin
    $readmemb("matlab_tx_real_H_127.txt", matlab_tx_real);
    $readmemb("matlab_tx_imag_H_127.txt", matlab_tx_imag);
end
