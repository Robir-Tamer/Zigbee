...
WaveRestoreCursors {{Cursor 2} {15 ns} 1} {{Cursor 4} {39 ns} 1} {{Cursor 6} {101 ns} 1 default Cyan} {{Cursor 5} {55 ns} 1 default Turquoise} {{Cursor 6} {63 ns} 1 default Turquoise} {{Cursor 7} {71 ns} 0 default Turquoise} {{Cursor 8} {101 ns} 0}
