...
integer dqpsk_correct;
    ...
    //david will provide the matlab output for 1Mbps  and we will compare with that
        if (test_case == 0) begin //0 byte
            $readmemb("../Tx_output/AI_0_Payload/250Kbps/00_tx_real_250Kbps.txt", matlab_tx_real);
            $readmemb("../Tx_output/AI_0_Payload/250Kbps/00_tx_imag_250Kbps.txt", matlab_tx_imag);
            $readmemb("../Tx_output/AI_0_Payload/250Kbps/06_QPSK_OUT_250K.txt", matlab_QPSK);
            $readmemb("../Tx_output/AI_0_Payload/250Kbps/04_interleaver_output_250K.txt", matlab_interleaver);
            $readmemb("../Tx_output/AI_0_Payload/250Kbps/03_symbolmapper_output_250K.txt", matlab_symbol_mapper);
            $readmemb("../Tx_output/AI_0_Payload/250Kbps/02_demux_output_250K.txt", matlab_demux);
            $readmemb("../Tx_output/AI_0_Payload/250Kbps/01_zeropadding_output_250K.txt", matlab_zero_padding);
            $readmemb("../Tx_output/AI_0_Payload/250Kbps/07_DQPSK_OUT_250K.txt", matlab_dqpsk);
        end
         else if (test_case == 1) begin //1 byte
            $readmemb("../Tx_output/AI_1_Payload/250Kbps/00_tx_real_250Kbps.txt", matlab_tx_real);
            $readmemb("../Tx_output/AI_1_Payload/250Kbps/00_tx_imag_250Kbps.txt", matlab_tx_imag);
            $readmemb("../Tx_output/AI_1_Payload/250Kbps/06_QPSK_OUT_250K.txt", matlab_QPSK);
            $readmemb("../Tx_output/AI_1_Payload/250Kbps/04_interleaver_output_250K.txt", matlab_interleaver);
            $readmemb("../Tx_output/AI_1_Payload/250Kbps/03_symbolmapper_output_250K.txt", matlab_symbol_mapper);
            $readmemb("../Tx_output/AI_1_Payload/250Kbps/02_demux_output_250K.txt", matlab_demux);
            $readmemb("../Tx_output/AI_1_Payload/250Kbps/01_zeropadding_output_250K.txt", matlab_zero_padding);
            $readmemb("../Tx_output/AI_1_Payload/250Kbps/07_DQPSK_OUT_250K.txt", matlab_dqpsk);

        end
        else if (test_case == 2) begin //28byte
            $readmemb("../Tx_output/AI_28_Payload/250Kbps/00_tx_real_250Kbps.txt", matlab_tx_real);
            $readmemb("../Tx_output/AI_28_Payload/250Kbps/00_tx_imag_250Kbps.txt", matlab_tx_imag);
            $readmemb("../Tx_output/AI_28_Payload/250Kbps/06_QPSK_OUT_250K.txt", matlab_QPSK);
            $readmemb("../Tx_output/AI_28_Payload/250Kbps/04_interleaver_output_250K.txt", matlab_interleaver);
            $readmemb("../Tx_output/AI_28_Payload/250Kbps/03_symbolmapper_output_250K.txt", matlab_symbol_mapper);
            $readmemb("../Tx_output/AI_28_Payload/250Kbps/02_demux_output_250K.txt", matlab_demux);
            $readmemb("../Tx_output/AI_28_Payload/250Kbps/01_zeropadding_output_250K.txt", matlab_zero_padding);
            $readmemb("../Tx_output/AI_28_Payload/250Kbps/07_DQPSK_OUT_250K.txt", matlab_dqpsk);
            //to be written by david
        end
        else if (test_case == 3) begin //127byte
            $readmemb("../Tx_output/AI_127_Payload/250Kbps/00_tx_real_250Kbps.txt", matlab_tx_real);
            $readmemb("../Tx_output/AI_127_Payload/250Kbps/00_tx_imag_250Kbps.txt", matlab_tx_imag);
            $readmemb("../Tx_output/AI_127_Payload/250Kbps/06_QPSK_OUT_250K.txt", matlab_QPSK);
            $readmemb("../Tx_output/AI_127_Payload/250Kbps/04_interleaver_output_250K.txt", matlab_interleaver);
            $readmemb("../Tx_output/AI_127_Payload/250Kbps/03_symbolmapper_output_250K.txt", matlab_symbol_mapper);
            $readmemb("../Tx_output/AI_127_Payload/250Kbps/02_demux_output_250K.txt", matlab_demux);
            $readmemb("../Tx_output/AI_127_Payload/250Kbps/01_zeropadding_output_250K.txt", matlab_zero_padding);
            $readmemb("../Tx_output/AI_127_Payload/250Kbps/07_DQPSK_OUT_250K.txt", matlab_dqpsk);
        end
