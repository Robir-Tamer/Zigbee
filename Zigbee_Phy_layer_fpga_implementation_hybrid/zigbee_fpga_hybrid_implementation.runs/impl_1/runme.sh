...
HD_PWD='D:/zigbee_fpga_implementation/zigbee_fpga_hybrid_implementation/zigbee_fpga_hybrid_implementation.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zigbee_fpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zigbee_fpga.tcl -notrace
