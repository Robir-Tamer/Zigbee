...
HD_PWD='D:/zigbee_fpga_implementation/zigbee_fpga_hybrid_implementation/zigbee_fpga_hybrid_implementation.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zigbee_fpga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zigbee_fpga.tcl
