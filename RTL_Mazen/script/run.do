...
vlog -work work ../rtl/Sync_FIFO_mem.v
...
add wave -noupdate -color "Orange" -radix binary /tb_top_sym_to_ppdu/u_ut/rst_n
...
add wave -noupdate -color "Magenta" -radix hexadecimal /tb_top_sym_to_ppdu/u_ut/u_symbol_mapper_odd/o_data
add wave -noupdate -color "Magenta" -radix binary      /tb_top_sym_to_ppdu/u_ut/u_symbol_mapper_odd/o_valid
...
add wave -noupdate -color "Wheat" -radix binary      /tb_top_sym_to_ppdu/u_ut/u_sync_fifo_odd/empty_flag
add wave -noupdate -color "Wheat" -radix hexadecimal /tb_top_sym_to_ppdu/u_ut/u_sync_fifo_odd/dout

# --- 3. INTERLEAVER (Even & Odd) - [مكان المشكلة الأساسي] ---
...
add wave -noupdate -color "Gold" -radix binary      /tb_top_sym_to_ppdu/u_ut/u_interleaver_even/i_data
...
add wave -noupdate -color "Orange" -radix binary    /tb_top_sym_to_ppdu/u_ut/u_interleaver_odd/i_valid
add wave -noupdate -color "Orange" -radix binary    /tb_top_sym_to_ppdu/u_ut/u_interleaver_odd/i_data
add wave -noupdate -color "Orange" -radix binary    /tb_top_sym_to_ppdu/u_ut/u_interleaver_odd/o_data
add wave -noupdate -color "Orange" -radix binary    /tb_top_sym_to_ppdu/u_ut/u_interleaver_odd/o_valid
